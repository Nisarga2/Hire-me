...
<input type="text" name="fullname" placeholder="Full Name" onkeypress='javascript: return isNumber(event)' required autocomplete="off"/>
</div>
<script>
    // Write the validation script.
    function isNumber(evt) {
        var iKeyCode = (evt.which) ? evt.which : evt.keyCode
        if (iKeyCode != 46 && iKeyCode > 33 && (iKeyCode < 65 || iKeyCode > 90) && (iKeyCode < 97 || iKeyCode > 122))
